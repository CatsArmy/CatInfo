...
namespace CatInfo
{
    public class TabinfoInterface
    {
        public static void Setup()
        {
            ...
            TabInfoManager.RegisterStat(chargedCat, "Plasma Charged Bullet Even Spread", (p) => CatInfo.ChargedEvenSpread && p.data.weaponHandler.gun.useCharge && p.data.weaponHandler.gun.chargeEvenSpreadTo != 0, (p) => string.Format("{0:F2}",p.data.weaponHandler.gun.chargeEvenSpreadTo));
            TabInfoManager.RegisterStat(chargedCat, "Plasma Charged Bullet Even Spread", (p) => CatInfo.ChargedEvenSpread && p.data.weaponHandler.gun.useCharge && p.data.weaponHandler.gun.chargeEvenSpreadTo != 0, (p) => string.Format("{0:F2}",p.data.weaponHandler.gun.chargeEvenSpreadTo));
